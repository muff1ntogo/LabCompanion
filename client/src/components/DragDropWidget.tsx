...
export function WidgetItem({ type, onAdd }: WidgetItemProps) {
  ...
  return (
    <div
      ref={drag}
      className={`p-3 border-2 border-dashed border-gray-300 rounded-lg cursor-move
...
export function PlacedWidget({ 
  ...
  return (
    ...
    >
      <Card className="w-64 bg-white border shadow-md hover:shadow-lg transition-shadow">
